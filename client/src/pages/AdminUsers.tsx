  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button onClick={() => setShowForm(!showForm)} className="btn btn-accent btn-sm">
      ...
      {showForm && (
        <div className="card p-5 mb-6 animate-fade-in">
          {error && <div className="mb-4 p-3 rounded-lg text-sm" style={{ background: '#fef2f2', color: 'var(--danger)' }}>{error}</div>}
